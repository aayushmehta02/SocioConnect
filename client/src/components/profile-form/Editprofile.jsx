...
function Editprofile({createProfile, getCurrentProfile, profile: {profile, loading}}) {
  ...
  return (
    ...
    <form className="form" onSubmit={e=>onSubmit(e)}>
      ...
      <div className="my-2">
        <button onClick={()=>toggleSocialInputs(!displaySocailInputs)} type="button" className="btn btn-dark">
          {displaySocailInputs? "Hide Social Network Links" :" Add Social Metwork links"}
        </button>
        <span>Optional</span>
      </div>
            {displaySocailInputs && <div>
